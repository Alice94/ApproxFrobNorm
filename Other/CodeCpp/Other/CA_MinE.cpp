...
void SelectNextCross_MinE(long int* m, long int* n, double* B, long int* k, long int* t, double* it, double* jt);

void SelectNextCross_MinE(long int* m, long int* n, double* B, long int* k, long int* t, double* it, double* jt) {
  
  // Initialization for time checks
  clock_t t1, t2;
  clock_t clockInitialSVD = 0, clockBidiagonalize = 0, clockPoly = 0, clockBidiagonalSVD = 0, clockTridiagonalize = 0, clockDGBBRD = 0;
